...
const Benifits = () => {
    ...
    return (
<motion.div
    className="h-fit xl:h-screen flex flex-col 2xl:flex-row items-center justify-center gap-6 sm:gap-8 xl:gap-12 p-4 sm:px-6 md:px-8 lg:px-12 xl:px-50 xl:mb-80 2xl:mb-30 "
    ref={ref}
...
>
<Image
    className="mb-6 xl:mb-0 w-full max-w-[400px] sm:max-w-[300px] md:max-w-[350px] lg:max-w-[400px] 2xl:max-w-none"
    ...
    <div className="flex flex-col gap-6 sm:gap-8 mb-10 xl:mb-0">
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 2xl:grid-cols-3 gap-4">
                <div className="h-auto md:min-h-[195px] w-full bg-[#F5F5F5] hover:bg-white group flex flex-col gap-2 p-4 rounded-[10px] hover:shadow-lg smooth3 hover:scale-105">
        ...
        className="flex items-center justify-center px-4 py-3 bg-primary rounded-full w-full md:w-1/3  text-white text-base hover:text-primary hover:bg-white hover:border-primary border border-white smooth3">
            Connect With Us
        </button>
    </div>
</motion.div>
